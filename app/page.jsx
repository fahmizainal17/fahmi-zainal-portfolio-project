  ...
  return (
    <header className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <Link href="/">
          <h1 className="text-2xl font-bold">Data Scientist @ Invoke</h1>
        </Link>
        <nav>
...
/* Review Section with auto-scrolling testimonials */function ReviewSection() {
  const testimonials = [
    {
      id: 1,
      quote: "Fahmi's guidance has been invaluable in my career as a data analyst. His expertise in Python, SQL, and machine learning is outstanding.",
      reviewer: "Iqmal Zamri, Healthcare Data Analytics"
    },
    {
      id: 2,
      quote: "Transitioning from the army to data science, Fahmi brings discipline and problem-solving skills that make him an exceptional data scientist.",
      reviewer: "Ammar Azman, Data Scientist"
    },
    {
      id: 3,
      quote: "Fahmi's professionalism and teamwork led us to a top 28% Kaggle ranking. He's a valuable teammate and a fast learner.",
      reviewer: "Hazman Naim Bin Ahsan, Data Scientist at Apecia"
    },
    {
      id: 4,
      quote: "During our Data Analytics Bootcamp, Fahmi’s leadership and real-world application of skills set him apart from his peers.",
      reviewer: "Pearly Toh Swee Ling, Career Success Manager"
    },
    {
      id: 5,
      quote: "Excellent work! Not only do you have strong coding skills, but you also bring an exceptional touch to presentation aesthetics. The ChatGPT integration works smoothly, making analysis faster and more efficient. Overall, a well-executed and beautifully designed solution. Well done!",
      reviewer: "Ahmad Fairus Zamri, CEO of AFZ Solutions"
    },
    {
      "id": 6,
      "quote": "Impressive execution! The attention to detail in both functionality and design sets this project apart. The ChatGPT integration enhances workflow efficiency, making tasks much smoother. Fantastic job!",
      "reviewer": "Jonathan Reeves, CTO of NexaTech"
    },
    {
        "id": 7,
        "quote": "Brilliant work! The seamless integration and clean user interface demonstrate true expertise. This solution is both practical and aesthetically pleasing. Highly recommended!",
        "reviewer": "Sophia Lin, Product Manager at InnovateX"
    },
    {
        "id": 8,
        "quote": "Top-tier quality! The coding structure is solid, and the presentation is visually appealing. The AI-driven analysis speeds up decision-making tremendously. Exceptional job!",
        "reviewer": "David Martinez, Founder of AI Solutions Inc."
    }
  ];
  ...
  // Duplicate array untuk seamless loop tanpa glitch
      ...
      <div className="container mx-auto px-4 overflow-hidden">
        ...
        <div className="w-full overflow-hidden relative">
          <motion.div
            ...
            transition={{ repeat: Infinity, duration: 25, ease: "linear" }} // 15s untuk lebih smooth
            onMouseEnter={() => setIsPaused(true)}
            onMouseLeave={() => setIsPaused(false)}
            style={{ display: "flex" }}
          >
            {loopedTestimonials.map((testimonial, index) => (
              <div key={index} className="min-w-[300px] max-w-sm bg-purple-600 text-white p-6 rounded-lg shadow-lg">
